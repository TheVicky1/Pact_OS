    ...
    <div ref={containerRef} className="relative inline-block text-left">
      ...
      {isOpen && (
        <div
          ...
          className="absolute right-0 top-full mt-2 w-72 sm:w-80 rounded-3xl border border-white/[0.08] bg-[#121217]/95 backdrop-blur-2xl shadow-2xl shadow-black/80 p-4 space-y-3.5 z-50 animate-in fade-in zoom-in-95 duration-150"
        >
          {/* Profile Header Card */}
          <div className="flex items-center gap-3.5 p-2">
            <div className="w-11 h-11 rounded-2xl bg-gradient-to-br from-[#262218] via-[#1a1822] to-[#121217] border border-[#d4af37]/50 flex items-center justify-center font-bold text-sm text-[#e2c056] shadow-md shadow-black/40 shrink-0">
              {userInitial}
            </div>
          ...
          {/* Account Navigation Action Links */}
          <div className="space-y-1">
            <Link
              href="/app/settings"
              onClick={handleClose}
              className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-xs sm:text-sm font-medium text-zinc-300 hover:text-zinc-100 hover:bg-white/[0.05] transition-colors group"
            >
            ...
            <Link
              ...
              className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-xs sm:text-sm font-medium text-zinc-300 hover:text-zinc-100 hover:bg-white/[0.05] transition-colors group"
            >
              <ShieldAlert className="w-4 h-4 text-zinc-400 group-hover:text-amber-400 transition-colors shrink-0" />
              <span>Accountability Rules</span>
            </Link>
            ...
            <Link
              ...
              className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-xs sm:text-sm font-medium text-zinc-300 hover:text-zinc-100 hover:bg-white/[0.05] transition-colors group"
            >
              <Database className="w-4 h-4 text-zinc-400 group-hover:text-sky-400 transition-colors shrink-0" />
              <span>Data & Privacy Archive</span>
            </Link>
          </div>
          ...
          <form action={signOutAction} className="w-full">
            <button
              type="submit"
              className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-xs sm:text-sm font-medium text-rose-400 hover:text-rose-300 hover:bg-rose-500/10 transition-colors cursor-pointer text-left"
            >
