/**
 * Goals page skeleton loader.
 * Matches the actual GoalCard layout so the transition from skeleton to content
 * is visually stable.
 */
    ...
    <div className="space-y-8 animate-pulse">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-zinc-800/80 pb-6">
        <div className="space-y-2">
          ...
          <div className="h-3 w-64 bg-zinc-800/60 rounded-full" />
        </div>
        <div className="h-9 w-28 bg-zinc-800 rounded-xl shrink-0" />
      </div>

      {/* Toolbar skeleton */}
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4">
        <div className="h-9 w-80 bg-zinc-900 border border-zinc-800 rounded-xl" />
...
function GoalCardSkeleton() {
  return (
    <div className="glass-card p-5 sm:p-6 rounded-2xl border border-zinc-800/80 flex flex-col space-y-4">
      {/* Card header */}
