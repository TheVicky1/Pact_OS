...
export function StreakSummaryCard({ metrics }: StreakSummaryCardProps) {
  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
      {/* 1. Today's Progress */}
      <div className="bg-[#121217]/80 border border-white/[0.08] rounded-2xl p-4 backdrop-blur-xl transition-all duration-200 hover:border-[#d4af37]/30 hover:shadow-lg">
