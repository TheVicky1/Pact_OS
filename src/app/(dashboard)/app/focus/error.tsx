...
export default function FocusError({
  ...
  useEffect(() => {
    console.error('Focus route error caught:', error);
  }, [error]);
  ...
  return (
    <PageContainer as="main">
      <div className="w-full max-w-xl mx-auto my-12 p-6 sm:p-8 bg-[#121217] border border-rose-500/30 rounded-3xl text-center space-y-4 shadow-2xl">
        ...
        <h2 className="text-xl font-bold text-zinc-100">Focus Session Unavailable</h2>
        <p className="text-sm text-zinc-400">
          An error occurred while loading your focus timer or history.
        </p>
