...
export default function FinanceError({
  ...
  useEffect(() => {
    console.error('Finance page error caught:', error);
  }, [error]);
  ...
  return (
    <PageContainer as="main">
      <div className="py-24 flex flex-col items-center justify-center text-center">
        ...
        <h2 className="text-xl font-bold text-white mb-2">Unable to load finance data</h2>
        <p className="text-sm text-zinc-400 max-w-md mb-6">
          We encountered an issue while loading your financial records. Please try again.
        </p>
        <button
          type="button"
          onClick={() => reset()}
