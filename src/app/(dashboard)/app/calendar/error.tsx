      ...
      <div className="py-12 max-w-lg mx-auto">
        <GlassCard variant="default" padding="lg" className="space-y-4 text-center">
          ...
          <div className="space-y-1">
            <h2 className="text-base font-bold text-zinc-100">Calendar Unavailable</h2>
            <p className="text-xs text-zinc-400">
              An unexpected error occurred while loading your daily calendar.
            </p>
          </div>

          <Alert variant="danger">
            {error.message || 'Failed to render daily calendar.'}
          </Alert>
