...
2. **Uphold Engineering Integrity**: Beginner-friendly does not mean lowering engineering standards. Strict TypeScript, zero secret leakage, integer-cents currency arithmetic, and 100% pass rates across the 40-suite test matrix are required for all merged code.
